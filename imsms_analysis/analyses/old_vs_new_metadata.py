...
if __name__ == "__main__":
    ...
    if DO_CATEGORICAL:
        ...
        combined_categorical["Disease_Course"] = combined_categorical[["Disease_Course"]].apply(fix_missing_controls, axis=1)
        combined_categorical["Disease_Status"] = combined_categorical[["Disease_Status"]].apply(fix_missing_controls, axis=1)
        combined_categorical["Treatment_Status"] = combined_categorical[["Treatment_Status"]].apply(fix_missing_controls, axis=1)
        combined_categorical["Treatment_Type"] = combined_categorical[["Treatment_Type"]].apply(fix_missing_controls, axis=1)
